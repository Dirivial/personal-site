...
pubDate: 2023-01-23
tags: ["python", "machine learning", "ML", "seaborn", "matplotlib"]
---

import heatmap_iris from "../../images/seaborn/heatmap_iris.png";
import heatmap_titanic from "../../images/seaborn/heatmap_titanic.png";
import hist_kde from "../../images/seaborn/hist_kde.png";
import histogram from "../../images/seaborn/histogram.png";
import scatter_color from "../../images/seaborn/scatter_color.png";
import scatter_iris from "../../images/seaborn/scatter_iris.png";
import scatter_legend_outside from "../../images/seaborn/scatter_legend_outside.png";
import scatter_legend from "../../images/seaborn/scatter_legend.png";
import scatter_size_shape from "../../images/seaborn/scatter_size_shape.png";
...
Next up is histograms, which are available with 'histplot'. These can get confusing by adding colors, but if you need them they are available. Note that unlike scatterplots these **cannot** have 'style' or 'size'.
...
option. It may sound scary but it is simple. Take a look! ```python sns.histplot(x='sepal_length',
data=iris, kde=True) ```
...
Before touching on a bit on the more advanced things you can do with seaborn we will take a look at heatmaps. They are great for finding correlations within data as you will see shortly. Because you are familiar with how creating plots look like by now we will jump straight into a more advanced heatmap.
